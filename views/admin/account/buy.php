...
<div class="panel panel-default">
  	...
  	<div class="panel-body">
  		<form class="form-horizontal" name="form1" id="form1" onsubmit="return checkma()" action="controller/buy.php" method="POST" entype="multipart/data">
  			<div align="right">
	  		...
	  		<div class="alert alert-info">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="list">รายการ</label>
		  			<div class="col-xs-6">
		    			<input name="list" id="list" type="text" class="form-control input-lg" />
		  			</div>
		  		</div>
	  			<div class="form-group">
