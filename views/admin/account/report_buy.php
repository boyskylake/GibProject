<?php 
  ...
  $AC=new Account();
	...
	$sql = "SELECT *,COUNT(list) AS Clist, SUM(b_money) AS Smoney FROM buy GROUP BY date ORDER BY date DESC";
	$db->query($sql);
  		...
  		<table class="table table-hover">
	  		...
	  		?>
	  			<tr>
	  				...
	  				<td>
	  					<a href="account.php?v=DayDetail&Day=<?php echo $rs['date']; ?>&sum=<?php echo $rs['Smoney']; ?>" 
