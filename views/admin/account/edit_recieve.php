...
<div class="panel panel-warning">
  	...
  	<div class="panel-body">
    	<h3><?php echo $_GET['Day']; ?></h3>
      	<hr></hr>
        <form entype="multipart/data" class="form-horizontal" 
          role="form" action="controller/edit_recieve.php" method="POST">
    		<?php 
          $i=1;
