<?php 
  ...
  $AC=new Account();
	...
	$sql = "SELECT *,COUNT(`from`) AS Rlist, SUM(`r_money`) AS Rmoney FROM recieve GROUP BY date ORDER BY date DESC";
	$db->query($sql);
...
<div class="panel panel-info">
      ...
      <!-- END PAGINATION -->
          ...
          $count++;
            ...
            <td>
            <a href="account.php?v=RDetail&Day=<?php echo $rs['date']; ?>&sum=<?php echo $rs['Rmoney']; ?>" 
	  						class="btn btn-success btn-sm">
	  						<span class="glyphicon glyphicon-eye-open"></span>
	  					</a>
	  					&nbsp;
	  					<span class="label label-info">
	  						<?php echo $rs['Rlist']; ?>&nbsp;รายการ
	  					</span>
            </td>
	  				<td>
              <div align="right">
