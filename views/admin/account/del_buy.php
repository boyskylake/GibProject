  	...
  	<div class="panel-body">
        ...
        <div class="alert alert-danger">
	        <div class="form-group">
	          ...
	          <div class="col-sm-10">
	            <p class="form-control-static"><?php echo $rs['list']; ?></p>
	          </div>
	        </div>
	        ...
	        <div class="form-group">
	          ...
	          <div class="col-sm-10">
	            <p class="form-control-static"><?php echo $rs['b_money']; ?>&nbsp;&nbsp;&nbsp;บาท</p>
	          </div>
	        </div>
	    
	        <div class="form-group">
	        	<div class="col-sm-10">
	         	<a href="controller/del_buy.php?ID=<?php echo $rs['id']; ?>" class="btn btn-danger btn-xs">
