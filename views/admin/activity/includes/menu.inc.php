  <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="../news/data_news_add.php">เพิ่มข่าวประชาสัมพันธ์</a>
                <a class="dropdown-item" href="../news/data_news.php">จัดการข่าวประชาสัมพันธ์</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#">กิจกรรม</a>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="data_act_add.php">เพิ่มกิจกรรม</a>
                <a class="dropdown-item" href="data_act.php">จัดการกิจกรรม</a>
              </div>
            </li>
            <li class="nav-item">
