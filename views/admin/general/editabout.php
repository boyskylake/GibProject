...
<?php 
  ...
  require_once ('lib/DB.php');
    ...
    $sql = "SELECT * FROM `td_about` WHERE `Id` = '".$id."'";
    $db->query($sql);
    $res = $db->fetch_assoc();


 ?>
<form id="form1" name="form1" method="POST" action="general.php?v=process_editabout" onsubmit="return checkma()">
